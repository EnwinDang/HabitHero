...
export type PatchNotification = Partial<Pick<Notification, "isRead" | "title" | "body" | "data">>;
...
export const NotificationsAPI = {
  ...
  create(n: Notification): Promise<Notification> {
    return apiFetch<Notification>("/notifications", { method: "POST", body: JSON.stringify(n) });
  },
  ...
  patch(notificationId: string, patch: PatchNotification): Promise<Notification> {
    return apiFetch<Notification>(`/notifications/${notificationId}`, {
      method: "PATCH",
