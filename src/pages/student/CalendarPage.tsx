      ...
      >
        <div className="space-y-4">
          ...
          {imagePreview ? (
            ...
            <label className={`flex flex-col items-center justify-center gap-3 p-8 border-2 border-dashed rounded-xl cursor-pointer ${darkMode ? 'hover:bg-gray-800/40 border-gray-700' : 'hover:bg-gray-50 border-gray-300'}`}>
              ...
              {showConfirm ? (
                <div className="flex gap-1">
                  <button
                    ...
                    className={`text-xs px-2 py-1 ${darkMode ? "bg-red-600 hover:bg-red-700" : "bg-red-500 hover:bg-red-600"} text-white rounded transition-colors`}
                  >
                    Delete
                  </button>
                  <button
